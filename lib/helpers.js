...
exports.magnet = function(hash, size) {
  var out = "<a href=\"";
  out = out+"magnet:?xt=urn:btih:"+hash+'&tr=udp://tracker.publicbt.com:80/announce&tr=udp://tracker.openbittorrent.com:80/announce&tr=udp://tracker.ccc.de:80&tr=udp://open.demonii.com:1337';
  out = out + '"><img src="img/';
